...
namespace DataTransferObject
{
    public class TTCaNhanDTO
    {
        ...
        private float SoCMND;

        public float _SoCMND
        {
            get { return SoCMND; }
            set { SoCMND = value; }
        }
        ...
        public TTCaNhanDTO(int MaNV, string HoTen, DateTime NgaySinh, string GioiTinh,
                                    string QueQuan, string TTHonNhan, float SoCMND, DateTime NgayCap, string NoiCap,
                                    float SĐT, string DanToc, string TonGiao, string HocVan, string HocHam, string GhiChu )
        {
            this.MaNV = MaNV;
            this.HoTen = HoTen;
