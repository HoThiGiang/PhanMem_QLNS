...
namespace QuanLiNhanSu
{
    public partial class frmChamCong : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                int hang = e.RowIndex;
                cbbMaNV.Text = dataGridView1.Rows[hang].Cells[0].Value.ToString();
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            try
            {
                chamcongdto._MaNV = Convert.ToInt32(cbbMaNV.Text);
                ...
                if (cbbMaNV.Text != "" && txtSoNgayCong.Text != "" && txtSoNgayNghi.Text != "" && txtNam.Text !="" && txtThang.Text !="")
                {
